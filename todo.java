...
public class todo{
    ...
    public static void addItems(File file){
        ...
        try{
            ...
            //     System.out.println("if we don't want to add anymore item , then press 0, it will automatically comes out of the  loop.");
            //     while(stop==1){
            //         System.out.println(item);
            //         fwrite.write(item);
            //         System.out.println("press 1 to continue adding items or press 0 to stop ");
    ...
    public static void main(String[] args){
        ...
        // scanner.nextLine();
        // int tracker =scanner.nextInt();
        // tracker = select_number;
